...
class TextResponseReader implements ResponseReaderInterface {
	 ...
	 *
	 * @param string $prefix
	 *        	Identifier for a type of reply.
	 * @param ResponseHandlerInterface $handler
	 *        	Response handler for the reply.
	 */
	 ...
	 *
	 * @param ComposableConnectionInterface $connection
	 *        	Connection to Redis that generated the error.
