...
class Client implements ClientInterface {
	 ...
	 *
	 * @param mixed $parameters
	 *        	Connection parameters or instance.
	...
	protected function initializeConnection($parameters) {
		...
		if (is_callable ( $parameters )) {
			...
			if (! $connection instanceof ConnectionInterface) {
				throw new \InvalidArgumentException ( 'Callable parameters must return instances of Predis\Connection\ConnectionInterface' );
			}
	 ...
	 * client is connected to a cluster.
	 * The new instance will use the same
	 ...
	 * @param ResponseErrorInterface $response
	 *        	The error response instance.
	 * @return mixed
	 */
	 ...
	 *
	 * @param
	 *        	mixed ... Options for the context, a callable object, or both.
	 ...
	 *        	Optional callable object used to execute the context.
	 * @return PipelineContext|array
	 */
