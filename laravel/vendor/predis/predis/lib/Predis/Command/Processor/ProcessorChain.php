...
class ProcessorChain implements CommandProcessorChainInterface, \ArrayAccess {
	 ...
	 *        	List of instances of CommandProcessorInterface.
	 */
	...
	public function offsetSet($index, $processor) {
		if (! $processor instanceof CommandProcessorInterface) {
			throw new \InvalidArgumentException ( 'A processor chain can hold only instances of classes implementing ' . 'the Predis\Command\Processor\CommandProcessorInterface interface' );
		}
