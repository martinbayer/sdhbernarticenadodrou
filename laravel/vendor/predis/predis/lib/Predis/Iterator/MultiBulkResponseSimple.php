...
class MultiBulkResponseSimple extends MultiBulkResponse {
	 ...
	 *        	Connection to Redis.
	 * @param int $size
	 *        	Number of elements of the multibulk reply.
	 */
	 ...
	 * then PHP's garbage collector kicks in (e.g.
	 * then the iterator goes
	 ...
	 *
	 * @param bool $drop
	 *        	True to synchronize the client by dropping the connection.
