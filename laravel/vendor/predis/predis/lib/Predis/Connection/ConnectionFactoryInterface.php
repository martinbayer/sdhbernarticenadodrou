...
interface ConnectionFactoryInterface {
	 ...
	 *
	 * @param string $scheme
	 *        	URI scheme identifying the connection class.
	 * @param mixed $initializer
	 *        	FQN of a connection class or a callable object for lazy initialization.
	 */
	 ...
	 *
	 * @param AggregatedConnectionInterface $cluster
	 *        	Instance of an aggregated connection class.
	 * @param array $parameters
	 *        	List of parameters for each connection object.
