...
class HashKeyTest extends PredisTestCase {
	...
	public function testIterationWithNoResults() {
		...
		$client->expects ( $this->once () )->method ( 'hscan' )->with ( 'key:hash', 0, array () )->will ( $this->returnValue ( array (
				0,
				array () 
		) ) );
	...
	public function testIterationOnMultipleFetches() {
		...
		$client->expects ( $this->any () )->method ( 'getProfile' )->will ( $this->returnValue ( ServerProfile::get ( '2.8' ) ) );
		$client->expects ( $this->at ( 1 ) )->method ( 'hscan' )->with ( 'key:hash', 0, array () )->will ( $this->returnValue ( array (
				2,
				array (
						'field:1st' => 'value:1st',
						'field:2nd' => 'value:2nd' 
		...
		$client->expects ( $this->at ( 2 ) )->method ( 'hscan' )->with ( 'key:hash', 2, array () )->will ( $this->returnValue ( array (
				0,
				array (
						'field:3rd' => 'value:3rd' 
				) 
	...
	public function testIterationOnMultipleFetchesAndHoleInFirstFetch() {
		...
		$client->expects ( $this->at ( 2 ) )->method ( 'hscan' )->with ( 'key:hash', 4, array () )->will ( $this->returnValue ( array (
				0,
				array (
						'field:1st' => 'value:1st',
						'field:2nd' => 'value:2nd' 
	...
	public function testIterationOnMultipleFetchesAndHoleInMidFetch() {
		...
		$client->expects ( $this->at ( 3 ) )->method ( 'hscan' )->with ( 'key:hash', 5, array () )->will ( $this->returnValue ( array (
				0,
				array (
						'field:3rd' => 'value:3rd' 
				) 
	...
	public function testIterationWithOptionMatch() {
		...
		$client->expects ( $this->any () )->method ( 'getProfile' )->will ( $this->returnValue ( ServerProfile::get ( '2.8' ) ) );
		$client->expects ( $this->at ( 1 ) )->method ( 'hscan' )->with ( 'key:hash', 0, array (
				'MATCH' => 'field:*' 
	...
	public function testIterationWithOptionMatchOnMultipleFetches() {
		...
		$client->expects ( $this->at ( 2 ) )->method ( 'hscan' )->with ( 'key:hash', 1, array (
				'MATCH' => 'field:*' 
		) )->will ( $this->returnValue ( array (
				0,
				array (
	...
	public function testIterationRewindable() {
		...
		$client->expects ( $this->any () )->method ( 'getProfile' )->will ( $this->returnValue ( ServerProfile::get ( '2.8' ) ) );
		$client->expects ( $this->exactly ( 2 ) )->method ( 'hscan' )->with ( 'key:hash', 0, array () )->will ( $this->returnValue ( array (
				0,
				array (
						'field:1st' => 'value:1st',
						'field:2nd' => 'value:2nd' 
