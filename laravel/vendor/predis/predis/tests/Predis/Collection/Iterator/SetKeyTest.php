...
class SetKeyTest extends PredisTestCase {
	...
	public function testIterationWithNoResults() {
		...
		$client->expects ( $this->once () )->method ( 'sscan' )->with ( 'key:set', 0, array () )->will ( $this->returnValue ( array (
				0,
				array () 
		) ) );
	...
	public function testIterationOnMultipleFetches() {
		...
		$client->expects ( $this->any () )->method ( 'getProfile' )->will ( $this->returnValue ( ServerProfile::get ( '2.8' ) ) );
		$client->expects ( $this->at ( 1 ) )->method ( 'sscan' )->with ( 'key:set', 0, array () )->will ( $this->returnValue ( array (
				2,
				array (
						'member:1st',
						'member:2nd' 
		...
		$client->expects ( $this->at ( 2 ) )->method ( 'sscan' )->with ( 'key:set', 2, array () )->will ( $this->returnValue ( array (
				0,
				array (
						'member:3rd' 
				) 
	...
	public function testIterationOnMultipleFetchesAndHoleInFirstFetch() {
		...
		$client->expects ( $this->at ( 2 ) )->method ( 'sscan' )->with ( 'key:set', 4, array () )->will ( $this->returnValue ( array (
				0,
				array (
						'member:1st',
						'member:2nd' 
	...
	public function testIterationOnMultipleFetchesAndHoleInMidFetch() {
		...
		$client->expects ( $this->at ( 3 ) )->method ( 'sscan' )->with ( 'key:set', 5, array () )->will ( $this->returnValue ( array (
				0,
				array (
						'member:3rd' 
				) 
	...
	public function testIterationWithOptionMatch() {
		...
		$client->expects ( $this->any () )->method ( 'getProfile' )->will ( $this->returnValue ( ServerProfile::get ( '2.8' ) ) );
		$client->expects ( $this->at ( 1 ) )->method ( 'sscan' )->with ( 'key:set', 0, array (
				'MATCH' => 'member:*' 
	...
	public function testIterationWithOptionMatchOnMultipleFetches() {
		...
		$client->expects ( $this->at ( 2 ) )->method ( 'sscan' )->with ( 'key:set', 1, array (
				'MATCH' => 'member:*' 
		) )->will ( $this->returnValue ( array (
				0,
				array (
	...
	public function testIterationRewindable() {
		...
		$client->expects ( $this->any () )->method ( 'getProfile' )->will ( $this->returnValue ( ServerProfile::get ( '2.8' ) ) );
		$client->expects ( $this->exactly ( 2 ) )->method ( 'sscan' )->with ( 'key:set', 0, array () )->will ( $this->returnValue ( array (
				0,
				array (
						'member:1st',
						'member:2nd' 
