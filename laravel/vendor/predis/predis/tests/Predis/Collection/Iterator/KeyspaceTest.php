...
class KeyspaceTest extends PredisTestCase {
	...
	public function testIterationWithNoResults() {
		...
		$client->expects ( $this->once () )->method ( 'scan' )->with ( 0, array () )->will ( $this->returnValue ( array (
				0,
				array () 
		) ) );
	...
	public function testIterationOnMultipleFetches() {
		...
		$client->expects ( $this->any () )->method ( 'getProfile' )->will ( $this->returnValue ( ServerProfile::get ( '2.8' ) ) );
		$client->expects ( $this->at ( 1 ) )->method ( 'scan' )->with ( 0, array () )->will ( $this->returnValue ( array (
				2,
				array (
						'key:1st',
						'key:2nd' 
		...
		$client->expects ( $this->at ( 2 ) )->method ( 'scan' )->with ( 2, array () )->will ( $this->returnValue ( array (
				0,
				array (
						'key:3rd' 
				) 
	...
	public function testIterationOnMultipleFetchesAndHoleInFirstFetch() {
		...
		$client->expects ( $this->at ( 2 ) )->method ( 'scan' )->with ( 4, array () )->will ( $this->returnValue ( array (
				0,
				array (
						'key:1st',
						'key:2nd' 
	...
	public function testIterationOnMultipleFetchesAndHoleInMidFetch() {
		...
		$client->expects ( $this->at ( 3 ) )->method ( 'scan' )->with ( 5, array () )->will ( $this->returnValue ( array (
				0,
				array (
						'key:3rd' 
				) 
	...
	public function testIterationWithOptionMatch() {
		...
		$client->expects ( $this->any () )->method ( 'getProfile' )->will ( $this->returnValue ( ServerProfile::get ( '2.8' ) ) );
		$client->expects ( $this->at ( 1 ) )->method ( 'scan' )->with ( 0, array (
				'MATCH' => 'key:*' 
	...
	public function testIterationWithOptionMatchOnMultipleFetches() {
		...
		$client->expects ( $this->at ( 2 ) )->method ( 'scan' )->with ( 1, array (
				'MATCH' => 'key:*' 
		) )->will ( $this->returnValue ( array (
				0,
				array (
	...
	public function testIterationRewindable() {
		...
		$client->expects ( $this->any () )->method ( 'getProfile' )->will ( $this->returnValue ( ServerProfile::get ( '2.8' ) ) );
		$client->expects ( $this->exactly ( 2 ) )->method ( 'scan' )->with ( 0, array () )->will ( $this->returnValue ( array (
				0,
				array (
						'key:1st',
						'key:2nd' 
