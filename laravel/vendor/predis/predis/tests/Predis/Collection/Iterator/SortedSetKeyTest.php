...
class SortedSetKeyTest extends PredisTestCase {
	...
	public function testThrowsExceptionOnInvalidServerProfile() {
		...
		$client->expects ( $this->any () )->method ( 'getProfile' )->will ( $this->returnValue ( ServerProfile::get ( '2.0' ) ) );
	...
	public function testIterationWithNoResults() {
		...
		$client->expects ( $this->once () )->method ( 'zscan' )->with ( 'key:zset', 0, array () )->will ( $this->returnValue ( array (
				0,
				array () 
		) ) );
	...
	public function testIterationOnMultipleFetches() {
		...
		$client->expects ( $this->any () )->method ( 'getProfile' )->will ( $this->returnValue ( ServerProfile::get ( '2.8' ) ) );
		$client->expects ( $this->at ( 1 ) )->method ( 'zscan' )->with ( 'key:zset', 0, array () )->will ( $this->returnValue ( array (
				2,
				array (
						array (
								'member:1st',
		...
		$client->expects ( $this->at ( 2 ) )->method ( 'zscan' )->with ( 'key:zset', 2, array () )->will ( $this->returnValue ( array (
				0,
				array (
						array (
								'member:3rd',
	...
	public function testIterationOnMultipleFetchesAndHoleInFirstFetch() {
		...
		$client->expects ( $this->at ( 2 ) )->method ( 'zscan' )->with ( 'key:zset', 4, array () )->will ( $this->returnValue ( array (
				0,
				array (
						array (
								'member:1st',
	...
	public function testIterationOnMultipleFetchesAndHoleInMidFetch() {
		...
		$client->expects ( $this->at ( 3 ) )->method ( 'zscan' )->with ( 'key:zset', 5, array () )->will ( $this->returnValue ( array (
				0,
				array (
						array (
								'member:3rd',
	...
	public function testIterationWithOptionMatch() {
		...
		$client->expects ( $this->any () )->method ( 'getProfile' )->will ( $this->returnValue ( ServerProfile::get ( '2.8' ) ) );
		$client->expects ( $this->at ( 1 ) )->method ( 'zscan' )->with ( 'key:zset', 0, array (
				'MATCH' => 'member:*' 
	...
	public function testIterationWithOptionMatchOnMultipleFetches() {
		...
		$client->expects ( $this->at ( 2 ) )->method ( 'zscan' )->with ( 'key:zset', 1, array (
				'MATCH' => 'member:*' 
		) )->will ( $this->returnValue ( array (
				0,
				array (
	...
	public function testIterationRewindable() {
		...
		$client->expects ( $this->any () )->method ( 'getProfile' )->will ( $this->returnValue ( ServerProfile::get ( '2.8' ) ) );
		$client->expects ( $this->exactly ( 2 ) )->method ( 'zscan' )->with ( 'key:zset', 0, array () )->will ( $this->returnValue ( array (
				0,
				array (
						array (
								'member:1st',
