...
class HelpersTest extends PredisTestCase {
	...
	public function testOnCommunicationException() {
		...
		$exception = $this->getMockForAbstractClass ( 'Predis\CommunicationException', array (
				$connection 
		) );
	...
	public function testFilterArrayArguments() {
		...
		$this->assertSame ( $arguments, Helpers::filterArrayArguments ( array (
				$arguments 
		) ) );
	...
	public function testFilterVariadicValues() {
		...
		$this->assertSame ( $arguments, Helpers::filterVariadicValues ( array (
				'key',
				array (
						'value1',
						'value2',
