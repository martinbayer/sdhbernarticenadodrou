...
class CommandTest extends PredisTestCase {
	...
	public function testNormalizeArguments() {
		...
		$this->assertSame ( $arguments, AbstractCommand::normalizeArguments ( array (
				$arguments 
		) ) );
	...
	public function testNormalizeVariadic() {
		...
		$this->assertSame ( $arguments, AbstractCommand::normalizeVariadic ( array (
				'key',
				array (
						'value1',
						'value2',
