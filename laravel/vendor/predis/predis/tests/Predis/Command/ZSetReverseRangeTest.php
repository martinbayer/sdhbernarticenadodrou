...
class ZSetReverseRangeTest extends PredisCommandTestCase {
	...
	public function testReturnsElementsInRange() {
		...
		$this->assertSame ( array (
				'f' 
		), $redis->zrevrange ( 'letters', 0, 0 ) );
		$this->assertSame ( array (
				'f',
				'e',
				'd',
				'c' 
		), $redis->zrevrange ( 'letters', 0, 3 ) );
		...
		$this->assertSame ( array (
				...
				'b',
				'a' 
		), $redis->zrevrange ( 'letters', 0, - 1 ) );
		$this->assertSame ( array (
				'f',
				'e',
				'd' 
		), $redis->zrevrange ( 'letters', 0, - 4 ) );
		$this->assertSame ( array (
				'd' 
		), $redis->zrevrange ( 'letters', 2, - 4 ) );
		$this->assertSame ( array (
				'f',
				'e',
				'd',
				...
				'b',
				'a' 
		), $redis->zrevrange ( 'letters', - 100, 100 ) );
	...
	public function testRangeWithWithscoresModifier() {
		...
		$this->assertSame ( $expected, $redis->zrevrange ( 'letters', 2, 4, array (
				'withscores' => true 
		) ) );
	}
