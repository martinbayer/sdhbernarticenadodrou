...
class ZSetRangeTest extends PredisCommandTestCase {
	...
	public function testReturnsElementsInRange() {
		...
		$this->assertSame ( array (
				'a' 
		), $redis->zrange ( 'letters', 0, 0 ) );
		$this->assertSame ( array (
				'a',
				'b',
				'c',
				'd' 
		), $redis->zrange ( 'letters', 0, 3 ) );
		...
		$this->assertSame ( array (
				...
				'e',
				'f' 
		), $redis->zrange ( 'letters', 0, - 1 ) );
		$this->assertSame ( array (
				'a',
				'b',
				'c' 
		), $redis->zrange ( 'letters', 0, - 4 ) );
		$this->assertSame ( array (
				'c' 
		), $redis->zrange ( 'letters', 2, - 4 ) );
		$this->assertSame ( array (
				'a',
				'b',
				'c',
	...
	public function testRangeWithWithscoresModifier() {
		...
		$this->assertSame ( $expected, $redis->zrange ( 'letters', 2, 4, array (
				'withscores' => true 
		) ) );
	}
