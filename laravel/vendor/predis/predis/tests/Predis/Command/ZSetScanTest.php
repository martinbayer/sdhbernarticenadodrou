...
class ZSetScanTest extends PredisCommandTestCase {
	...
	public function testScanWithoutMatch() {
		...
		$this->assertSame ( $expectedMembers, array_map ( function ($e) {
			return $e [0];
		}, $response [1] ) );
		$this->assertSame ( $expectedScores, array_map ( function ($e) {
			return $e [1];
		}, $response [1] ) );
	}
