...
class ZSetRangeByScoreTest extends PredisCommandTestCase {
	...
	public function testReturnsElementsInScoreRange() {
		...
		$this->assertSame ( array (
				'a' 
		), $redis->zrangebyscore ( 'letters', - 10, - 10 ) );
		$this->assertSame ( array (
				'c',
				'd',
				'e',
				'f' 
		), $redis->zrangebyscore ( 'letters', 10, 30 ) );
		$this->assertSame ( array (
				'd',
				'e' 
		), $redis->zrangebyscore ( 'letters', 20, 20 ) );
	...
	public function testInfinityScoreIntervals() {
		...
		$this->assertSame ( array (
				...
				'b',
				'c' 
		), $redis->zrangebyscore ( 'letters', '-inf', 15 ) );
		$this->assertSame ( array (
				'd',
				'e',
				'f' 
		), $redis->zrangebyscore ( 'letters', 15, '+inf' ) );
		$this->assertSame ( array (
				'a',
				'b',
				'c',
				...
				'e',
				'f' 
		), $redis->zrangebyscore ( 'letters', '-inf', '+inf' ) );
	}
	...
	public function testRangeWithWithscoresModifier() {
		...
		$this->assertSame ( $expected, $redis->zrangebyscore ( 'letters', 10, 20, array (
				'withscores' => true 
		) ) );
	}
