...
if (! interface_exists ( 'SessionHandlerInterface' )) {
	die ( "ATTENTION: the session handler implemented by Predis needs PHP >= 5.4.0 or a polyfill " . "for \SessionHandlerInterface either provided by you or an external package.\n" );
}
...
$handler = new Predis\Session\SessionHandler ( $client, array (
		'gc_maxlifetime' => 5 
) );
