...
class PHPParser_Tests_TemplateLoaderTest extends PHPUnit_Framework_TestCase {
	public function testLoadWithoutSuffix() {
		$templateLoader = new PHPParser_TemplateLoader ( new PHPParser_Parser ( new PHPParser_Lexer () ), dirname ( __FILE__ ) );
	...
	public function testLoadWithSuffix() {
		$templateLoader = new PHPParser_TemplateLoader ( new PHPParser_Parser ( new PHPParser_Lexer () ), dirname ( __FILE__ ), '.php' );
	...
	public function testNonexistentBaseDirectoryError() {
		new PHPParser_TemplateLoader ( new PHPParser_Parser ( new PHPParser_Lexer () ), dirname ( __FILE__ ) . '/someDirectoryThatDoesNotExist' );
	}
