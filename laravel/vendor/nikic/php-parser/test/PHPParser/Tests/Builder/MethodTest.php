...
class PHPParser_Tests_Builder_MethodTest extends PHPUnit_Framework_TestCase {
	...
	public function testModifiers() {
		...
		$this->assertEquals ( new PHPParser_Node_Stmt_ClassMethod ( 'test', array (
				'type' => PHPParser_Node_Stmt_Class::MODIFIER_PUBLIC | PHPParser_Node_Stmt_Class::MODIFIER_ABSTRACT | PHPParser_Node_Stmt_Class::MODIFIER_STATIC,
				'stmts' => null 
		) ), $node );
		...
		$this->assertEquals ( new PHPParser_Node_Stmt_ClassMethod ( 'test', array (
				'type' => PHPParser_Node_Stmt_Class::MODIFIER_PROTECTED | PHPParser_Node_Stmt_Class::MODIFIER_FINAL 
		) ), $node );
	...
	public function testParams() {
		...
		$node = $this->createMethodBuilder ( 'test' )->addParam ( $param1 )->addParams ( array (
				$param2,
				$param3 
		) )->getNode ();
	...
	public function testStmts() {
		...
		$node = $this->createMethodBuilder ( 'test' )->addStmt ( $stmt1 )->addStmts ( array (
				$stmt2,
				$stmt3 
		) )->getNode ();
	...
	public function testAddStmtToAbstractMethodError() {
		$this->createMethodBuilder ( 'test' )->makeAbstract ()->addStmt ( new PHPParser_Node_Expr_Print ( new PHPParser_Node_Scalar_String ( 'test' ) ) );
	}
	...
	public function testMakeMethodWithStmtsAbstractError() {
		$this->createMethodBuilder ( 'test' )->addStmt ( new PHPParser_Node_Expr_Print ( new PHPParser_Node_Scalar_String ( 'test' ) ) )->makeAbstract ();
	}
	...
	public function testInvalidParamError() {
		$this->createMethodBuilder ( 'test' )->addParam ( new PHPParser_Node_Name ( 'foo' ) );
	}
}