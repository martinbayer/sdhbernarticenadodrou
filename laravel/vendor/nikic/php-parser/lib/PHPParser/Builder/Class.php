...
class PHPParser_Builder_Class extends PHPParser_BuilderAbstract {
	 ...
	 * Extends a class.
	 *
	 * @param PHPParser_Node_Name|string $class
	 ...
	 *
	 * @param PHPParser_Node_Name|string $interface
	 *        	Name of interface to implement
	 * @param PHPParser_Node_Name|string $...
	 ...
	 * Adds a statement.
	 *
	 * @param PHPParser_Node_Stmt|PHPParser_Builder $stmt
